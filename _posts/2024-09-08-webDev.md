...
<div class="alert alert-remark">
  ...
  <div class="alert-body-remark">
   Ajoutez un lien au niveau du **mainheader** vers une nouvelle page qui s'appelle `cakes.html` qui contient un tableau montrant la liste des cakes disponibles dans la boutique. Créez cette page et ajoutez les cakes disponibles dans un tableau.
   </div>
</div>
---
