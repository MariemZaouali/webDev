...
Maintenant, nous allons sépécifier dans le footer, les auteurs du site en ajoutant le code suivant:
```html
 <footer>
...
Une page web a une structure qui est organisée par les éléments sémantiques du HTML. Nous comptons organiser la page `index.html` de manière
...
consacrons la partie à gauche pour la navigation et la partie à droite pour le contenu à rajouter.
