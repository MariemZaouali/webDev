...
Pour visualier le contenu de votre site, appuiez avec le bouton droit de la souris à l'écran et choisir **Open with Live Server**. A cette étape rien ne sera affiché.
```html
<!DOCTYPE html>
<html>
...
```
A cette étape là, qu'obtenez vous comme affichage sur votre site web? Expliquez que veut dire #main?
...
```
Visualisez votre page. A ce stade, la page ne semble organisée bien qu'elle contienne toutes les parties ciblées dans notre objectifs. Nous allons ajouter encore plus de style dans notre page afin d'améliorer le contenu.
```html
<style>
    body {
        margin-top: 0px;
...
```
Ajoutez les figures : **cake.svg** dans le **mainheader**, **logo.png** dans le **leftmenu** et **cakes.jpg** dans **main**. 
