...
Nous allons ajouter des images à notre page. Téléchargez le dossier images et mettez le sous **assets** dans votre projet. A METTRE
```link
...
TBD to be sent Friday 
## A vous de jouer
Vous allez transformer le code du premier TP du HTML/CSS natif vers Angular.
