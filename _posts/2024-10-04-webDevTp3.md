...
```
En écrivant ainsi, vous êtes entrain de définir un flux d'alimentation des données qui commence de la classe du composant vers l'attribut HTML. C'est un sens unique. Celà veuy dire, vous ne pouvez pas avec cette écriture aller de l'attribut HTML vers la classe du composant.
