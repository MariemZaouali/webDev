...
body onload="getRandomQuote()"> <!-- Call the function on page load -->
    <div class="jumbotron text-center">
      ...
      <a href="/features/addquote/addquote.html" class="btn btn-success">Add a Quote</a>
      <a href="/features/quotelist/quotelist.html" class="btn btn-info">List all Quotes</a>
    </div>
  
    <script>
    // Function to get a random quote
    function getRandomQuote() {
        fetch('/japi/randomquotes')
          .then(response => response.json())
          .then(data => {
...
```
Jusqu'à ce niveau, rien ne fonctionne !
